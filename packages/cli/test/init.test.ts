...
// Mocked by resolved file path (not the "@todti/..." package specifier) so
// the mock also intercepts the ecosystem adapter's own internal relative import
// of the same file — see packages/npm/src/adapter.ts.
